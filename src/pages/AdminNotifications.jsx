...
function AdminNotifications() {
  ...
  const handleViewDetails = (notification) => {
    ...
    if (notification.category === 'Question Bank') {
      navigate('/admin/question-bank');
    } else if (notification.category === 'Evaluation Assignment') {
      navigate('/admin/evaluation-assignment');
    } else if (notification.category === 'Evaluation Management') {
    ...
    } else if (notification.category === 'Answer Sheet Uploads') {
      navigate('/admin/answer-sheet-uploads');
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header" style={{ flexDirection: 'column', alignItems: 'flex-start', padding: '20px 30px', height: 'auto' }}>
        <h2 style={{ fontSize: '24px', margin: '0 0 8px 0' }}>Admin Notifications</h2>
        <p style={{ margin: 0, color: '#6c757d', fontSize: '0.95rem' }}>
          Monitor system activity, faculty evaluation progress, and student requests.
        </p>
      </div>
        ...
        <div className="notifications-filters">
          ...
          <div className="notifications-controls">
            ...
            >
              ...
              <option value="Evaluation Assignment">Evaluation Assignment</option>
              <option value="Evaluation Management">Evaluation Management</option>
              <option value="Answer Sheet Uploads">Answer Sheet Uploads</option>
