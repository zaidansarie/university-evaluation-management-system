...
function FacultySettings() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/faculty/${facultyId}/profile`);
      if (res.ok) {
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px 24px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Faculty Name</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.name || 'Not Available'}</div>
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Faculty ID</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.faculty_id || 'Not Available'}</div>
              </div>
              <div>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Designation</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.designation || 'Not Available'}</div>
              </div>
              <div>
