...
function AdminSettings() {
  ...
  const fetchProfile = async () => {
    try {
      setLoading(true);
      // Reusing API structure, adjust if actual API differs
      const res = await fetch(`http://localhost:5000/api/admin/${adminId}/profile`);
      if (res.ok) {
    ...
    <div className="dashboard-container">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '800px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <div>
              ...
              <p style={{ margin: 0, color: '#64748b', fontSize: '14px' }}>Basic account details and professional information.</p>
            </div>
            <button 
          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px 24px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Admin Name</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.name || 'Not Available'}</div>
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Employee ID</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.employee_id || 'Not Available'}</div>
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Role</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.role || 'Not Available'}</div>
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Department</label>
                <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>{profile.department || 'Not Available'}</div>
              </div>
              <div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              { id: 'studentActivity', label: 'Student Activity', desc: 'Get notified about new student registrations or profile updates.' },
              { id: 'facultyActivity', label: 'Faculty Activity', desc: 'Alerts regarding faculty assignments and activities.' },
              { id: 'resultPublishing', label: 'Result Publishing', desc: 'Notifications when results are ready to be published.' },
              { id: 'recheckingRequests', label: 'Rechecking Requests', desc: 'Updates when new rechecking requests are submitted.' },
        ...
        {/* Section 6: System Preferences (Admin Only) */}
        <div style={{
          backgroundColor: '#fff',
          borderRadius: '12px',
          border: '1px solid #e2e8f0',
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p style={{ margin: 0, color: '#64748b', fontSize: '14px' }}>Global system configurations and default settings.</p>
          </div>
          
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px 24px' }}>
            <div style={{ padding: '16px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #f1f5f9' }}>
              <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Academic Session</label>
            ...
            <div style={{ padding: '16px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #f1f5f9' }}>
              ...
              <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>Visible after Admin Approval</div>
            </div>
            <div style={{ padding: '16px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #f1f5f9' }}>
              <label style={{ display: 'block', fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>Notification Mode</label>
              <div style={{ fontSize: '15px', color: '#334155', fontWeight: '500' }}>Enabled</div>
            </div>
          </div>
        </div>
