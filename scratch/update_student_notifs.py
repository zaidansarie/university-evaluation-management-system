...
with open('b:/Samarth/University Evaluation Management System/src/pages/student/StudentNotifications.jsx', 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Imports and INITIAL_NOTIFICATIONS
content = re.sub(
    r"import \{ useNavigate \} from 'react-router-dom';\nimport '\.\./AdminDashboard\.css';.*?(?=function StudentNotifications\(\) \{)",
...
with open('b:/Samarth/University Evaluation Management System/src/pages/student/StudentNotifications.jsx', 'w', encoding='utf-8') as f:
    f.write(content)

print("StudentNotifications.jsx updated successfully")
